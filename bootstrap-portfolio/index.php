...
$result = get_CURL ('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyC0FLFARZypjPDl6ljNaWt0aNG7pzP-GH8');
...
//Latest Video
$result = get_CURL('https://www.googleapis.com/youtube/v3/search?key=AIzaSyC0FLFARZypjPDl6ljNaWt0aNG7pzP-GH8&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResults=1&order=date&part=snippet');
...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron text-center">
      <img src="img/risma.jpeg" class="img-circle">
      <h1>Risma Nurcahyani</h1>
    ...
    <footer>
      <div class="container text-center">
        <div class="row">
          <div class="col-sm-12">
            <p>&copy; copyright 2017 | built with <i class="glyphicon glyphicon-heart"></i> by. <a href="http://instagram.com/rismanurcyn">Risma Nurcahyani</a>.</p>
          </div>
        </div>
        <!-- <div class="row">
          <div class="col-sm-12">
